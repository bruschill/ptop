...
Phase 1 Changes 1.1 through 1.3 are implemented and verified. Change 1.4 and
later changes have not started.
...
implementation began. Phase 0 and Phase 1 Changes 1.1 through 1.3 are complete.
The next implementation step is Phase 1 Change 1.4.
